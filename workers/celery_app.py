"""
HireSense AI — Celery Application
Configures broker, result backend, task routing, and retries.
"""
...
INCLUDE_TASKS = os.environ.get("CELERY_INCLUDE_TASKS", "1").strip().lower() not in {"0", "false", "no", "off"}
TASK_MODULES = [
    "tasks.resume_parser",
    "tasks.ai_scorer",
    "tasks.llm_explainer",
